...
const Home: React.FC<HomeProps> = ({ products }) => {
  ...
  return (
    <div className="animate-fadeIn pb-12">
      {/* Hero Section - Watch Store Focused */}
      <section className="relative h-[85vh] md:h-[80vh] bg-black text-white flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            <span className="text-blue-500 font-black uppercase tracking-[0.3em] md:tracking-[0.4em] text-[9px] md:text-xs mb-4 block animate-slideDown italic">Est. 2024 • Watch Specialists</span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 tracking-tighter uppercase italic leading-[1.0] md:leading-[0.9]">
              Precision <br/><span className="text-white/30">Timepieces</span>
            </h1>
            <p className="text-gray-300 text-base md:text-lg mb-10 max-w-xl font-medium leading-relaxed italic border-l-2 border-blue-600 pl-4 md:pl-6">
              Curating Pakistan's most exclusive watch collection. High-performance horology delivered via our verified Cash On Delivery network.
            </p>
      ...
      <section id="collection" className="container mx-auto px-4 py-12 md:py-24">
        <div className="flex flex-col md:flex-row items-end justify-between mb-10 md:mb-16 gap-4">
          <div className="max-w-xl">
            <span className="text-blue-600 font-black uppercase tracking-widest text-[9px] md:text-[10px] mb-2 block italic">Authenticity Guaranteed</span>
         ...
         <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
               <div className="space-y-4">
                  ...
                  <h4 className="font-black uppercase italic tracking-widest text-sm">Horology Lab Verified</h4>
                  <p className="text-xs text-gray-500 italic px-8">Every watch undergoes rigorous testing for accuracy and quality.</p>
               </div>
               <div className="space-y-4">
                  <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto shadow-sm text-blue-600">
                  ...
                  <p className="text-xs text-gray-500 italic px-8">Safe delivery to your doorstep with Cash on Delivery across Pakistan.</p>
               </div>
               <div className="space-y-4">
                  <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto shadow-sm text-blue-600">
                  ...
                  <p className="text-xs text-gray-500 italic px-8">We stand by our timepieces with a full 7-day inspection period.</p>
               </div>
            </div>
         </div>
      </section>
